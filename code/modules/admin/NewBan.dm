...
/datum/admins/proc/unbanpanel()
	...
	dat += "</table>"
	dat = "<html><head><title>Unban Panel</title></head><body><HR><B>Bans:</B> <FONT COLOR=blue>(U) = Unban , (E) = Edit Ban</FONT> - <FONT COLOR=green>([count] Bans)</FONT><HR><table border=1 rules=all frame=void cellspacing=0 cellpadding=3 >[dat]</body></html>"
