...
/obj/item/paper_bundle/attackby(obj/item/W as obj, mob/user as mob)
	...
	// merging bundles
		...
		if(istype(W, /obj/item/tool/tape_roll))
			return 0
...
/obj/item/paper_bundle/proc/burn_with_object(obj/item/flame/P, mob/user)
	var/class = "warning"
...
/obj/item/paper_bundle/fire_act()
	burn()

/obj/item/paper_bundle/proc/burn()
