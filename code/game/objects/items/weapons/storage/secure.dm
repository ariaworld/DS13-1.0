...
/obj/item/storage/secure
	...
	attack_self(mob/user as mob)
		...
		var/dat = text("<html><body><TT><B>[]</B><BR>\n\nLock Status: []",src, (src.locked ? "LOCKED" : "UNLOCKED"))
		var/message = "Code"
...
/obj/item/storage/secure/safe/CouldUseTopic(var/mob/user)
	..()
	if(clicksound && istype(user, /mob/living/carbon))
		playsound(src, clicksound, VOLUME_MID)

/obj/item/storage/secure/safe/CSECO/New()
		new /obj/item/gun/projectile/automatic/pulse_heavy(src)
		..()

/obj/item/storage/secure/safe/captain/New()
		new /obj/item/gun/projectile/revolver/hr(src)
